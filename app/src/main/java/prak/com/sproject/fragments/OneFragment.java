...
public class OneFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
   ...
   //  swipeRefreshLayout.setRefreshing(true);
        ...
        StringRequest todo=new StringRequest(Request.Method.GET, "http://apiscrum.alfatech.id/index.php/app/show_todo_sprint/"+idproject, new Response.Listener<String>() {
            @Override
...
swipeRefreshLayout.setRefreshing(false);            }
    ...
    public void onRefresh() {
        ...
        tampiltodo(OneFragment.this.idproject);
