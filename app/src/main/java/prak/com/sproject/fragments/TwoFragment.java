...
public class TwoFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void tampiltodo(String idproject) {
        ...
        StringRequest todo=new StringRequest(Request.Method.GET, "http://apiscrum.alfatech.id/index.php/app/show_doing_sprint/" + idproject, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        Log.e("doing error", String.valueOf(detailtodo));
    ...
    public void onRefresh() {
        ...
        tampiltodo(TwoFragment.this.idproject);
