...
public class DetailProject extends AppCompatActivity{
   ...
   // LinearLayout doneku;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detailproject);

        doingku=(LinearLayout)findViewById(R.id.doing);
      ...
      //  doneku=(LinearLayout)findViewById(R.id.done);
        ...
        listtodo=(ListView)findViewById(R.id.listviewtodo);
        ...
        doingku.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(),DetailProjectDoing.class);
...
//        doneku.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent i=new Intent(getApplicationContext(),DetailProjectDone.class);
//                i.putExtra("idprosent",idproject);
//                i.putExtra("titlesent",titleproject);
//                startActivity(i);
//            }
//        });
    ...
    private void tampiltodo(String idproject) {
        ...
        StringRequest todo=new StringRequest(Request.Method.GET, "http://servicescrum.16mb.com/app/show_todo_sprint/" + idproject + "?X-API-KEY=tifuad", new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                       ...
                       // statustodo = new String[detailtodo.length()];
                        ...
                        detailTodoAdapter = new DetailTodoAdapter(DetailProject.this, datatodo);
...
//                        jabatantim = new String[detailpro.length()];
                        ...
                        detailadapter = new DetailProjectAdapter(DetailProject.this, datadetail);
                        //listtim.setAdapter(detailadapter);
